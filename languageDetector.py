...
LANGUAGE_SAMPLES = [{"name":"English","file":"resources/english_sample.txt"},
                    ...
                    {"name":"Arabic","file":"resources/arabic_sample.txt"},
                    {"name":"Spanish","file":"resources/spanish_sample.txt"},
                    {"name":"Ukrainian","file":"resources/ukrainian_sample.txt"},
                    {"name":"Azeri","file":"resources/azeri_sample.txt"},
                    {"name":"Frensh","file":"resources/french_sample.txt"},
                    {"name":"Japanese","file":"resources/japanese_sample.txt"},
                    {"name":"Nepali","file":"resources/nepali_sample.txt"},
                    {"name":"Russian","file":"resources/russian_sample.txt"},
                    {"name":"Swahili","file":"resources/swahili_sample.txt"},
                    {"name":"Bengali","file":"resources/bengali_sample.txt"},
                    {"name":"Hausa","file":"resources/hausa_sample.txt"},
                    {"name":"Kinyarwanda","file":"resources/kinyarwanda_sample.txt"},
                    {"name":"Pashto","file":"resources/pashto_sample.txt"},
                    {"name":"Sinhala","file":"resources/sinhala_sample.txt"},
                    {"name":"Tamil","file":"resources/tamil_sample.txt"},
                    {"name":"Uzbek","file":"resources/uzbek_sample.txt"},
                    {"name":"Burmese","file":"resources/burmese_sample.txt"},
                    {"name":"Hindi","file":"resources/hindi_sample.txt"},
                    {"name":"Persian","file":"resources/persian_sample.txt"},
